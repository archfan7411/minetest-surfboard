...
function surfboard.on_punch(self, puncher)
	...
	if not self.driver then
		...
		if not (creative and creative.is_enabled_for
				...
				or not inv:contains_item("main", "surfboard:board") then
			local leftover = inv:add_item("main", "surfboard:board")
...
minetest.register_entity("surfboard:board", surfboard)


minetest.register_craftitem("surfboard:board", {
	description = "Surfboard",
	inventory_image = "surfboard_inv.png",
	wield_image = "surfboard_inv.png",
